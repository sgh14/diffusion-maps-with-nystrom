...
n_components, q, alpha, steps = find_optimal_hyperparameters(X_a, q_vals, alpha_vals, steps_vals, output_dir=output_dir, max_components=10)
# n_components, q, alpha, steps = 4, 1e-2, 1, 1
